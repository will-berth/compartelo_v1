        ...
        success: function(response){
            ...
            $.each(data.marcas, function(index, valor){
                ...
                <div class="col-md-1 mb-3">
                    <button class="btn card py-3 marca border-0 ${clase}" onclick="getItemByCategory('${categoria}', '${valor.marca}')" data-toggle="tooltip" data-placement="bottom" title="${valor.marca}">
...
function itemDetails(clave){
    $.ajax({
        ...
        success: function(response){
            ...
            $('#migaja-marca').prop('href', '/categoria/'+data.articulo[0].categorias[0].categoria +'/'+data.articulo[0].marcas.marca);
